...
from ui.raifence import Ui_MainWindow  # Cập nhật từ caesar thành railfence
import requests
...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        url = "http://127.0.0.1:5000/api/railfence/encrypt"  # Cập nhật URL API
        payload = {
    ...
    def call_api_decrypt(self):
        url = "http://127.0.0.1:5000/api/railfence/decrypt"  # Cập nhật URL API
        payload = {
